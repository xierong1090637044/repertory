      ...
      Bmob.Object.saveAll(billsObj).then(function (res) {
        ...
        for (var i = 0; i < res.length; i++) {
          ...
          if (i == (res.length - 1)) {
            ...
            const master = Bmob_new.Pointer('_User')
            const masterID = master.set(wx.getStorageSync("friendId"));

            const operater = Bmob_new.Pointer('_User')
            ...
            query.set("type", -1);
            query.set("opreater", operaterrID);
