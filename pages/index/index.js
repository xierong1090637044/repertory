...
Page({
   ...
   */
  data: {
    optionsLists: [{ name:"product storage", icon: '../../images/index/entering.png', url: '/pages/common/goods-select/goods-select?type=entering' },
      { name: 'Product outgoing', icon: '../../images/index/delivery.png', url: '/pages/common/goods-select/goods-select?type=delivery' },
      { name: 'Return storage', icon: '../../images/index/return_goods.png', url: '/pages/common/goods-select/goods-select?type=returing' },
      { name: 'inventory check', icon: '../../images/index/stocking.png', url: '/pages/common/goods-select/goods-select?type=counting' },
      { name: 'product management', icon: '../../images/index/goods.png',url: '/pages/goods/goods'},
      { name: 'Warehouse management', icon: '../../images/index/canvas.png', url: '/pages/second/stocks/stocks' },
      { name: 'customer management', icon: '../../images/index/customs.png',url: '/pages/second/custom/custom'},
      { name: 'supplier management', icon: '../../images/index/mine.png', url: '/pages/second/producer/producer'},
      { name: 'Collaborative management', icon: '../../images/index/togeter.png', url: '/pages/friends/friends' },
      { name: 'Profit and loss records', icon: '../../images/index/stock.png',url: '/pages/detail_finance/detail_finance'},
      { name: 'Operation record', icon: '../../images/index/order_history.png',url: '/pages/order_history/order_history'},
      { name: 'financial statements', icon: '../../images/index/finance.png',url: '/pages/finance/finance'},
